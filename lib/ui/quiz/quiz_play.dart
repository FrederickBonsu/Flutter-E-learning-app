...
import 'package:adessua/models/quiz_model.dart';
...
import 'package:adessua/ui/components/quiz_play_widget.dart';
import 'package:adessua/ui/quiz/result.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: Color.fromRGBO(17,	36	,56	, 1),
        child: Icon(Icons.done_outline_sharp,color:Colors.white),
        onPressed: (){
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Column(
        ...
        children: [
          Text("Q${widget.index+1} ${widget.questionModel.question}", style: TextStyle(fontSize: 18,),),
          SizedBox(height: 12,),
          GestureDetector(
            onTap: (){
